...
ggsave("results/figures/modeling/model_performance.png", performance_plot, 
       width = 10, height = 6, dpi = 300)

cat("Model performance plot saved to results/figures/modeling/model_performance.png\n")